  ...
  return (
    <>
      <div
        ...
        className={cn(
          'flex items-center gap-[var(--spacing-tree-item-gap)] min-h-[44px] py-[var(--spacing-tree-item-py)] px-[var(--spacing-tree-item-px)] rounded-[var(--radius-sm)] cursor-pointer',
