...
| 2026-02-22 | **NDS-064 Done:** FileUploadZone Pattern — Batch-Upload mit Status-Tracking, 16 L4-Tokens (`fuzpattern`), 52 Tests, 9 Stories. UX-Review: 4 Critical + 8 Major gefixt. |
...
| 2026-02-23 | **Welle 14+15 Done:** 6 neue Layout-Atome implementiert. Stack (VStack/HStack), Container, Grid (GridItem), Spacer, List (ListItem, DescriptionList, DescriptionTerm, DescriptionDetails). Separator um label/icon/labelPosition erweitert. 2011 Tests, Build OK. NDS-133 bis NDS-138 geschlossen. **Epic 0 + Epic 1 geschlossen.** |
