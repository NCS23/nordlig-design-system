  ...
  return (
    <div style={{ padding: '24px', maxWidth: '960px', fontFamily: "'Inter', -apple-system, sans-serif" }}>
      ...
      <Section title="Level 4 — Component Shadows">
        <div style={{ padding: '16px 20px', backgroundColor: '#f8fafc', border: '1px dashed #e2e8f0', borderRadius: '8px', color: '#94a3b8', fontSize: '13px', fontStyle: 'italic' }}>
          Aktuell keine komponentenspezifischen Shadow-Tokens definiert. Komponenten verwenden Level-3-Elevation-Tokens direkt (z.B. --shadow-elevation-low fuer Cards).
        </div>
        <div style={{ marginTop: '16px', padding: '12px 16px', backgroundColor: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '8px', fontSize: '12px', color: '#166534', fontFamily: 'monospace' }}>
          <div style={{ fontWeight: 700, marginBottom: '8px', fontFamily: 'inherit' }}>Referenzkette (Beispiel elevation.medium):</div>
          <div>--shadow-elevation-medium → var(--shadow-md) → var(--shadow-base-md) = 0 4px 6px ...</div>
        </div>
      </Section>
