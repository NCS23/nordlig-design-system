...
const a11yStories: A11yStoryConfig[] = [
  // ─── Atoms ────────────────────────────────────────────────────────────────
  { level: 'atoms', component: 'Alert', stories: ['all-variants', 'with-close-button', 'with-list-description'] },
  { level: 'atoms', component: 'Badge', stories: ['primary', 'neutral', 'error', 'info'] },
  { level: 'atoms', component: 'Button', stories: ['primary', 'secondary', 'destructive', 'ghost'] },
  { level: 'atoms', component: 'Checkbox', stories: ['basic', 'checked', 'disabled'] },
  { level: 'atoms', component: 'Input', stories: ['default', 'disabled', 'error'] },
  { level: 'atoms', component: 'Label', stories: ['default'] },
  { level: 'atoms', component: 'Link', stories: ['default'] },
  { level: 'atoms', component: 'Progress', stories: ['default'] },
  { level: 'atoms', component: 'Slider', stories: ['default'] },
  { level: 'atoms', component: 'Spinner', stories: ['default'] },
  { level: 'atoms', component: 'Switch', stories: ['basic', 'checked'] },
  ...
  { level: 'atoms', component: 'Avatar', stories: ['default', 'with-fallback'] },
  { level: 'atoms', component: 'Heading', stories: ['level-1'] },
  { level: 'atoms', component: 'Text', stories: ['body'] },
  { level: 'atoms', component: 'Separator', stories: ['default'] },
  { level: 'atoms', component: 'Skeleton', stories: ['basic'] },
  { level: 'atoms', component: 'Kbd', stories: ['default'] },
  { level: 'atoms', component: 'Code', stories: ['inline-code'] },
  ...
  { level: 'molecules', component: 'Accordion', stories: ['single-default'] },
  ...
  { level: 'molecules', component: 'RadioGroup', stories: ['basic'] },
  { level: 'molecules', component: 'Select', stories: ['default'] },
  { level: 'molecules', component: 'Stepper', stories: ['horizontal-default'] },
  { level: 'molecules', component: 'Tabs', stories: ['underline-default'] },
